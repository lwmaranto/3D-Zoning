...
class App extends Component {
  ...
  addCustomSceneObjects() {
    ...
    const geometryTwo = new THREE.BoxGeometry(
      this.props.siteLength,
      this.props.siteWidth,
      1
    );
...
class Container extends React.Component {
  constructor(props) {
    super(props);
    this.state = { isMounted: true, siteLength: 100, siteWidth: 50 };
    ...
    return (
      <>
        ...
        <div>
          <p>
            MAX BUILDING LENGTH:{" "}
            {calculateBuildingLength(this.state.siteLength)}
          </p>
          <p>
            MAX BUILDING WIDTH: {calculateBuildingWidth(this.state.siteWidth)}
          </p>
        </div>
      </>
    );
